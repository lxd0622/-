...
# Configs
outfname = 'GeoPlotExample.pdf'
datafile = 'data/worldbank/API_IT.NET.USER.ZS_DS2_en_csv_v2.csv'
shapefile = 'data/ne_10m_admin_0_countries_lakes/ne_10m_admin_0_countries_lakes.shp'
# '/data/ne_10m_admin_0_countries_lakes/ne_10m_admin_0_countries_lakes.shp'
